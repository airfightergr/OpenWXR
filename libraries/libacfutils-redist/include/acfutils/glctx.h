 ...
 * \file
 *
 * This file contains a portable method for creating, destroying and managing
 * OpenGL contexts in X-Plane. While X-Plane will provide you an OpenGL
 * context on the main thread, it is sometimes useful to create other
 * contexts for background threads for asynchronous work.
 *
 * @see glctx_create_invisible()
 * @see glctx_make_current()
 * @see glctx_destroy()
 *
 * OpenGL Versions
 * ---------------
 ...
 *
 * - if you specify major_ver <= 2, you will get OpenGL legacy
 *	(version 1.0 up to 2.1 core features)
 * - if you specify major_ver = 3, you will get OpenGL 3.2+ feature
 *	compatibility
 * - in all other cases, you will get up to OpenGL 4.1 feature
 *	compatibility.
 *
...
/**
 * @return B_TRUE if `ctx` is the current rendering context, B_FALSE otheriwse.
 */
